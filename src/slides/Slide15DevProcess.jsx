...
export default function Slide15DevProcess({ theme = 'light' }) {
  ...
  const steps = [
    { num: "01", title: "Discovery & Analysis", desc: "Requirements gathering, technical feasibility, and business goals alignment.", icon: Search },
    { num: "02", title: "Architecture & Planning", desc: "System design, tech stack selection, database modeling, and sprint roadmaps.", icon: Map },
    { num: "03", title: "UI/UX & Prototyping", desc: "Wireframing, interactive prototypes, design system creation, and user testing.", icon: Palette },
    { num: "04", title: "Agile Development", desc: "Clean code engineering, two-week sprint cycles, REST/GraphQL APIs, and microservices.", icon: Code2 },
    { num: "05", title: "QA & Security Audits", desc: "Automated unit/integration tests, performance tuning, and penetration audits.", icon: CheckCircle2 },
    { num: "06", title: "CI/CD Deployment", desc: "Automated build pipelines, cloud infrastructure provisioning, and production launch.", icon: Rocket },
    { num: "07", title: "24/7 Support & SLA", desc: "Active system monitoring, patch management, infrastructure scaling, and technical support.", icon: Headset },
    { num: "08", title: "Continuous Growth", desc: "Data analytics review, iterative feature upgrades, and long-term tech evolution.", icon: TrendingUp }
  ];
  ...
  return (
    <div className={`slide-container relative w-full h-full overflow-hidden flex flex-col justify-between p-6 sm:p-8 md:p-10 transition-colors duration-300 ${
      ...
      <div className={`relative z-10 shrink-0 flex items-center justify-between border-b pb-3 ${
        ...
        <div>
          <span className="text-xs font-bold tracking-widest text-cyan-500 uppercase">Methodology & Workflow</span>
          <h2 className="font-black italic uppercase tracking-tight text-2xl sm:text-3xl mt-0.5" style={{ color: isDark ? "#E0F2FE" : "#1E3A8A" }}>
            AGILE <span style={{ color: isDark ? "#38BDF8" : "#0891B2" }}>DEVELOPMENT PROCESS</span>
          </h2>
        </div>
