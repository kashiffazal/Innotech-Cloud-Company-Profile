...
export default function Slide12FeaturedProjects({ theme = 'light' }) {
  ...
  const projects = [
    {
      ...
      image: "/assets/5-portfolio-1-a-plus-hire/compressed/a-plus-hire-1.jpg",
    ...
    },
    {
      ...
      image: "/assets/5-portfolio-2-Block-IMS/compressed/block-ims-1.jpg",
    ...
    },
    {
      ...
      image: "/assets/5-portfolio-3-Unified-money-mino/px-conversions/umm (1).webp",
    ...
    },
    {
      ...
      image: "/assets/5-portfolio-4-Webo-360/compressed/webo360 (1).png",
    ...
    },
    {
      ...
      image: "/assets/5-portfolio-5-Y-CMS/compressed/y-cms (1).png",
    ...
    },
    {
      ...
      image: "/assets/5-portfolio-7-some-websites/px-conversions/WEBO-Software-Solutions.webp",
  ...
  return (
    <div className={`slide-container relative w-full h-full overflow-hidden flex flex-col justify-between p-6 sm:p-8 md:p-10 transition-colors duration-300 ${
      ...
      {/* Slide Header */}
      <div className={`relative z-10 shrink-0 flex items-center justify-between border-b pb-2 sm:pb-3 ${
        isDark ? 'border-slate-800' : 'border-slate-200'
      }`}>
        <div>
          <span className="text-xs font-bold tracking-widest text-cyan-500 uppercase">Track Record</span>
          <h2 className="font-black italic uppercase tracking-tight text-xl sm:text-2xl md:text-3xl mt-0.5" style={{ color: isDark ? "#E0F2FE" : "#1E3A8A" }}>
            FEATURED PROJECTS & <span style={{ color: isDark ? "#38BDF8" : "#0891B2" }}>CASE STUDIES</span>
          </h2>
        </div>
        <img src={isDark ? "/assets/2-Company-Logo/Final-b2.png" : "/assets/2-Company-Logo/Final.png"} alt="Innotech Logo" className="h-7 sm:h-8 object-contain" />
      </div>
            ...
            >
              ...
              <div className="p-3 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className={`text-xs font-bold mb-0.5 leading-snug ${isDark ? 'text-white' : 'text-slate-900'}`}>
                    {proj.name}
                  </h3>
